...
depends=('python2-dateutil' 'python2-cssutils' 'python2-cherrypy' 
         'python-mechanize' 'podofo' 'libwmf' 'python2-beautifulsoup3' 
         'imagemagick' 'poppler-qt' 'chmlib' 'python2-lxml' 'libusbx' 
         'python-imaging' 'shared-mime-info' 'python2-dnspython' 
         'libunrar' 'python2-pyqt' 'icu' 'libmtp' 'python2-netifaces')
...
md5sums=('7d598f5d69c006098208bba899a7ae2e'
         '370eaef633513f5cb9b4a672393013fd'
