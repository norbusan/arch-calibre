...
source=("https://download.calibre-ebook.com/${pkgver}/calibre-${pkgver}.tar.xz"
        ...
        "https://github.com/kovidgoyal/calibre/commit/68bbec179abc980ebcb3f13854d2e4fd46f4897c.patch")
sha256sums=('c98564e6b5599a4838c68b8266559a487d15abfc04331ad850fcbe09db884337'
            'SKIP'
            '29c0e6c0cfc67ad3a41368ac6e5f4526047d91fae59f1d5ab1cabac7b54ff64d')
validpgpkeys=('3CE1780F78DD88DF45194FD706BC317B515ACE7C')

prepare(){
  cd "${pkgname}-${pkgver}"

  # https://github.com/kovidgoyal/calibre/pull/839
  patch -p1 -i ../68bbec179abc980ebcb3f13854d2e4fd46f4897c.patch
